    ...
    return (
        <div className="group-list-view">
            <div className="flex justify-content-between align-items-center mb-2">
                <h1 className="text-2xl font-bold text-900 m-0">Group list</h1>
                <Button label="EXPORT GROUP" className="p-button-warning p-button-sm" />
            </div>
            ...
            <DataTable
                ...
                filterDisplay="row"
                className="p-datatable-sm group-list-table"
            ...
            <style jsx global>{`
                .group-list-table .p-datatable-thead > tr > th {
                ...
                .group-list-table .p-datatable-filter-row > td {
                    background: #fff;
                }
            `}</style>
        </div>
