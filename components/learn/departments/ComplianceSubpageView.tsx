...
type ComplianceSubpageViewProps = {
    title: string;
};

export default function ComplianceSubpageView({ title }: ComplianceSubpageViewProps) {
    return (
        <div className="surface-card border-round border-1 surface-border overflow-hidden">
            <div className="p-4 md:p-5 lg:p-6" style={{ maxWidth: "48rem" }}>
                <p className="m-0 mb-2">
                    <Link
                        href="/agent/learn/departments/compliance"
                ...
                <p className="text-600 line-height-3 m-0">
                    Detailed content for this page is not in the portal yet. Use the compliance department and internal policy
                    updates for authoritative guidance and forms.
                </p>
            </div>
        </div>
    );
