...
type ExperiorConnectWorkvivoViewProps = {
    loginUrl: string;
};

export default function ExperiorConnectWorkvivoView({ loginUrl }: ExperiorConnectWorkvivoViewProps) {
            ...
            <div style={{ maxWidth: "36rem" }} className="w-full">
                <div className="surface-card border-round border-1 surface-border shadow-2 p-4 md:p-5 mb-4 bg-white">
                    <p className="text-900 line-height-3 m-0 mb-3 text-base md:text-lg">
                        You are now leaving the main platform and opening <strong>Experior Connect (Workvivo)</strong>.
                    </p>
                ...
                <div className="flex flex-wrap gap-3">
                    {url ? (
                        ...
                        <span className={`${btnBase} opacity-70 cursor-default shadow-1`} style={primaryStyle}>
                            Confirm
                        </span>
                    )}
                    <button
