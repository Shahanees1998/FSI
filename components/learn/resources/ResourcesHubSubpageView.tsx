...
type ResourcesHubSubpageViewProps = {
    title: string;
};

export default function ResourcesHubSubpageView({ title }: ResourcesHubSubpageViewProps) {
    return (
        <div className="surface-card border-round border-1 surface-border overflow-hidden">
            <div className="p-4 md:p-5 lg:p-6" style={{ maxWidth: "48rem" }}>
                <p className="m-0 mb-2">
                    <Link
                        href="/agent/learn/resources/resources"
                ...
                <p className="text-600 line-height-3 m-0">
                    Detailed content for this page is not in the portal yet. Use head-office announcements and your upline for the
                    latest PDFs, links, and training.
                </p>
            </div>
        </div>
    );
